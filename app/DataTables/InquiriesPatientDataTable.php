...
class InquiriesPatientDataTable extends DataTable
{
    /**
    ...
    {
        return $this->builder()
                    ->setTableId('inquiries-patient-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('id_number')->title('ID Número'),
    ...
    {
        return 'InquiriesPatient_' . date('YmdHis');
    }
}
